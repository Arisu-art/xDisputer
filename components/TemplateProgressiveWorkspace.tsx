...
export default function TemplateProgressiveWorkspace({ round, slots, supportingReady, managerTemplateScope = null, managedExhibits, onSelectRound, onUploadLetter, onRemoveLetter, onExhibitsChange, onTemplateMutation, onMessage }: Props) {
