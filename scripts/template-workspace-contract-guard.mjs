...
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', "type Stage = 'ROUND' | 'SLOT' | 'UPLOAD'", 'Template Library must use progressive stages like Disputer template selection.');
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', 'templates-progressive-workspace manager-template-progressive-workspace', 'Template Library must reuse the native progressive workspace shell.');
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', "stage === 'ROUND'", 'Template Library must start with round selection stage.');
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', "stage === 'SLOT'", 'Template Library must have template selection stage.');
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', "stage === 'UPLOAD'", 'Template Library must have focused upload stage.');
...
has('components/templates/workspace/TemplateRoundOnlyLibrary.tsx', 'data-template-library-minimal="progressive-upload"', 'Template Library must expose progressive upload marker.');
...
has('app/manager-template-library-upload.css', 'progressive upload layout', 'Template Library upload CSS must declare progressive ownership.');
has('app/manager-template-library-upload.css', '.manager-template-progressive-workspace', 'Template Library layout must style progressive workspace.');
has('app/manager-template-library-upload.css', '.template-manager-slot-grid', 'Template Library layout must style template selection cards.');
has('app/manager-template-library-upload.css', '.template-native-upload-panel', 'Template Library layout must style the focused upload panel.');
