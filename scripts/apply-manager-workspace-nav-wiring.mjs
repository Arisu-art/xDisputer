...
function wireManagerConsoleShell() {
  ...
  if (!shellIsPlainSwitchContract(source)) throw new Error('Plain manager switch nav button contract could not be generated.');
  writeIfChanged(path, before, source, 'plain manager switch nav shell');
}
