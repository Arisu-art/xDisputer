...
must(page, 'salary_outputs', 'manager report page must use merged Salary + Outputs report type');
...
must(exportRoute, 'Salary + Outputs', 'report export must include merged salary and output report');
must(exportRoute, 'Output detail', 'salary output export must include output detail table');
