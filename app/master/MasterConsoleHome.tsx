...
export default async function MasterConsoleHome({ searchParams }: PageProps) {
  ...
  return <ConsoleShell
    ...
    header={{ eyebrow: 'Master operations', title: 'Manager command center.', description: 'Compact account RPC reads keep this dashboard fast while account directories stay paginated.' }}
  >
