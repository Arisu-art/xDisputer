...
function managerOperationsNav(activePanel: ManagerPanel) {
  return [
    ...
    { href: '/manager-workspace', label: 'Manager workspace' },
...
export default async function AdminPage({ searchParams }: PageProps) {
  ...
  return <ManagerConsoleShell mode="operations" email={profile?.email || user.email} accountLabel="Manager account" navItems={managerOperationsNav(activePanel)}>
    ...
    <section className="admin-monitor-card" data-admin-direct-workspace-switch="true"><div className="admin-monitor-card-header"><div><p>Workspace mode</p><h2>Manager workspace access</h2></div><a className="dashboard-card-link" href="/manager-workspace" data-admin-direct-workspace-link="true">Open Manager Workspace</a></div></section>
