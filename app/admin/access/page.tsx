...
export default async function AdminAccessPage({ searchParams }: PageProps) {
  ...
  const headerDescription = selectedView === 'overview' ? 'Client limits are controlled by the master account. Managers see capacity and daily usage in compact records.' : viewDescription(selectedView);
